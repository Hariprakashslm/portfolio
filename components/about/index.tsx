...
const PrimaryButton = styled.a`
  ...
  @keyframes primaryButtonPulse {
    ...
    50% { 
      box-shadow: 0 8px 25px rgba(139, 92, 246, 0.3), 0 0 30px rgba(139, 92, 246, 0.2);
    }
  }
`;
...
const SecondaryButton = styled.a`
  ...
  @keyframes secondaryButtonGlow {
    ...
    50% { 
      box-shadow: 0 4px 15px rgba(139, 92, 246, 0.2), 0 0 20px rgba(139, 92, 246, 0.3);
      border-color: #ec4899;
    }
  }
`;
...
const FloatingCircle = styled.div<{ size: number; top: string; left: string; delay: number; color: string }>`
  position: absolute;
...
const FloatingSquare = styled.div<{ size: number; top: string; left: string; delay: number; color: string }>`
  position: absolute;
  width: ${props => props.size}px;
  height: ${props => props.size}px;
  background: ${props => props.color};
...
const About = ({
  ...
  return (
    <AboutSection id="about" ref={sectionRef}>
      ...
      <FloatingElements>
        <FloatingCircle size={100} top="15%" left="10%" delay={0} color="rgba(139, 92, 246, 0.3)" />
        <FloatingCircle size={80} top="25%" right="20%" delay={2} color="rgba(236, 72, 153, 0.3)" />
        <FloatingCircle size={120} top="70%" left="15%" delay={4} color="rgba(59, 130, 246, 0.3)" />
        <FloatingSquare size={90} top="35%" right="10%" delay={1} color="rgba(16, 185, 129, 0.3)" />
        <FloatingSquare size={70} top="60%" right="30%" delay={3} color="rgba(245, 158, 11, 0.3)" />
      </FloatingElements>
      ...
      <AboutContainer>
        ...
        <AboutContent>
          Hello, I'm <HighlightedName>Hari Prakash</HighlightedName>, passionate about building smart and scalable web & mobile applications. 
          ...
          in full stack development, focusing on creating dynamic and scalable web applications. My expertise lies in both frontend and backend 
          technologies, making me a versatile developer capable of handling complex projects across multiple domains.
          <br /><br />
