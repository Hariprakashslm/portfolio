...
const ContentList = styled.ul`
  ...
  animation: listSlideIn 1s ease-out 0.7s both;
...
const ContentListItem = styled.li<{ 'data-index': number }>`
...
const Experience = ({
  ...
  return (
    <ContentSection id="experience" ref={sectionRef}>
      <DecorativeElement />
          ...
          {data.experiance_group?.map(
            (
              currentData: { 
                ...
                content_list?: RichTextField;
              },
              index: number
            ) => {
              // Use fallback field names if the expected ones don't exist
              const title = currentData.sub_title;
              const titleText = currentData.experiance_role;
              const description = currentData.description;
              const descriptionText = currentData.company;
              const contentList = currentData.content_list || currentData.roles_and_responsibility;
                    ...
                    {contentList && (
                      <PrismicRichText
                        ...
                        components={{
                          ...
                          listItem: (data) => <ContentListItem data-index={index}>{data.children}</ContentListItem>,
                        }}
                      />
                    )}
                    <ProgressBar />
